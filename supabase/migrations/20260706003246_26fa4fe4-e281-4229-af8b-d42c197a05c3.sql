...
BEGIN
  ...
  ELSE
    -- Fallback path: no explicit package or subscription on the payment.
    -- Prefer renewing the org's most-recent subscription.
    ...
    ELSE
      -- No prior subscription: pick the cheapest active package as a safe default.
