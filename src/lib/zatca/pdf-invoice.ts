...
function setXmpMetadata(doc: PDFDocument, title: string) {
  ...
  doc.setProducer("HBSpro — Fatoora-like invoicing");
  doc.setCreator("HBSpro Invoice Engine");
...
export async function generateInvoicePdf(input: InvoicePdfInput): Promise<Uint8Array> {
  ...
  drawLeftText(page, "Generated by HBSpro — Fatoora e-invoicing engine", M, 30, { font: ar, size: 8, color: rgb(0.5, 0.55, 0.62) });
