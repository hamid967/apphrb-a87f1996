...
export const HUB_SERVICES: HubService[] = [
  ...
  },
  {
    ...
    links: [
      { to: "/reports/executive", labelAr: "التقرير التنفيذي", labelEn: "Executive report" },
      { to: "/reports/templates", labelAr: "قوالب التقارير", labelEn: "Templates" },
    ],
    category: "core",
    hue: "from-info/25 to-primary/10",
  },
  {
    ...
    links: [
      { to: "/reports/templates", labelAr: "القوالب", labelEn: "Templates" },
      { to: "/reports/preview", labelAr: "معاينة التقرير", labelEn: "Report preview" },
    ],
    category: "core",
    hue: "from-primary/25 to-fuchsia-500/10",
  },
