          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                ...
                className="px-8 py-4 bg-[#C5A059] hover:bg-[#b38f4d] text-[#043927] font-bold rounded-xl transition-all shadow-lg hover:shadow-[#C5A059]/20 transform hover:-translate-y-1 inline-flex items-center gap-2"
              >
                ابدأ تجربتك المجانية
              </Link>
              <a
                href="#features"
                className="px-8 py-4 border border-white/20 hover:bg-white/5 text-white font-medium rounded-xl transition-all inline-flex items-center gap-2"
              >
                عرض المزايا
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
            {features.map((f) => {
              ...
              return (
                <div
                  key={f.title}
                  className="group p-8 rounded-3xl border border-stone-100 bg-stone-50/50 hover:bg-white hover:border-[#C5A059]/30 transition-all duration-300 hover:shadow-xl"
                >
                  <div className="w-12 h-12 bg-[#043927] rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
