...
const TOURS: Record<string, Tour> = {
  ...
  first_receipt: {
    ...
    hints: [
      {
        selector: '[data-coach="receipt-upload"], input[type="file"]',
        titleAr: "ارفق صورة الإيصال",
        titleEn: "Attach the receipt image",
        bodyAr: "PDF أو صورة واضحة تُظهر المبلغ والتاريخ.",
        bodyEn: "A clear PDF or image showing amount & date.",
      },
      {
        selector: '[data-coach="receipt-amount"], input[name="amount"], input[type="number"]',
        titleAr: "أدخل المبلغ",
        titleEn: "Enter the amount",
        bodyAr: "المبلغ بالريال السعودي — يمكنك إضافة ضريبة القيمة المضافة لاحقاً.",
        bodyEn: "Amount in SAR — VAT can be added later.",
      },
      {
        selector: '[data-coach="receipt-submit"], button[type="submit"]',
        titleAr: "أرسل المطالبة",
        titleEn: "Submit the claim",
        bodyAr: "ستُرسل للمراجعة والموافقة من المدير المالي.",
        bodyEn: "It goes to your finance manager for approval.",
      },
    ],
  },
  invite_team: {
